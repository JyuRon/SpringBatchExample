...
public class AsyncConfiguration {
    ...
    public AsyncConfiguration(JobBuilderFactory jobBuilderFactory,
    ...
    public Job userJob() throws Exception {
        return this.jobBuilderFactory.get(JOB_NAME)
                ...
                .next(this.userLevelUpStep())       //TODO: Async 적용
                ...
                .to(this.orderStatisticsStep(null))// 맞으면 해당 Step을 실행한다.
                .build()
                .build();
    }
